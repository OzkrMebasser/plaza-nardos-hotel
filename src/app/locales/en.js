export const en = {
  //MetaData
  meta: {
    description: `Located in the heart of Playa del Carmen, just a block from Fifth Avenue, 
    Plaza Nardo's is a newly remodeled hotel that offers a unique experience. 
    With its private beach and easy access to the best shops and restaurants, 
    you'll enjoy an unparalleled stay in the city’s tourist center. 
    Come and discover the comfort and charm of Plaza Nardo's!
  `,
  },
  ...
  cuadrupleBedRoom: {
    ...
    roomStuff: {
      tv: "Flat-screen TV",
      bedCovers: "Bed linens",
      downStairs: "Upper floors are accessible only by stairs",
      fan: "Fan",
      towels: "Towels",
      closet: "Closet",
      seatingRoom: "Seating area",
      ...
      ac: "Air conditioning",
      coatRack: "Coat rack",
      towelsSheets: "Towels/sheets (for an extra charge)",
    },
    viewsTitle: "View of:",
    views: {
      toBalcony: "Balcony",
  ...
  chatCard: {
    ...
    contactMessage:
      "Contact one of our agents to plan your next incredible vacation ",
    usualReplyTime: "Our usual reply time",
    replyTime: "Around ",
