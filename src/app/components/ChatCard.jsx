...
const ChatCard = () => {
  ...
  return (
    <div className="z-40 fixed w-full px-4 lg:w-[29rem] bottom-20 lg:bottom-5 md:px-4 md:right-4 lg:px-4 lg:right-20  ">
      <div
      ...
      <div
        onClick={toggleChat}
        className=" fixed bg-[#8c90b1] shadow-2xl right-3 bottom-3 rounded-full w-16 h-16 flex items-center justify-center cursor-pointer"
      >
